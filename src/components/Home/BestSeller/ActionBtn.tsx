...
// const ActionBtn = ({ handleClick, text, icon, addedToWishlist,isDisabled }: any) => {
...
//       <p
//         className={`bg-white text-dark text-xs leading-5 font-medium rounded-[5px] px-3 py-1.5 relative shadow-1 self-end capitalize duration-500 ${
